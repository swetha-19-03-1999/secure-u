                ...
                <Col  >
                    <div className="header-container">
                        ...
                        <div className=' brand-logo'>
                            ...
                            <p className="m-0  d-none d-md-block">Secure- <span>U</span></p>
                            {/* </div> */}
                        </div>
                        ...
                        <div className='setting_main '>
                            <InputGroup  >
                                ...
                                <Form.Control aria-label="Text input with checkbox" className="search-bar" />
                            </InputGroup>
                            <div className="d-flex align-items-center ">

                                <IoNotifications className='side_nav_icon ms-3 me-3' />
                                <Link to="/profile">
                                    <Image height={40} width={40} src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"
                                        roundedCircle />
                                </Link>
            ...
            <Row className="main-page d-flex">
                <Col xs={3} className="side-navigation">
                    ...
                    <div className='settings'>
                        ...
                        <div className='row_1 cian-cls' onClick={handleShow} type="button">
                            <div className='col_1 ' >
