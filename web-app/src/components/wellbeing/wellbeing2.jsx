    ...
    return (
        <div className="secure-zone-main grey-bg">
            ...
            >
                ...
                <Typography>
                    We want to hear from you! If you have any feedback on our
                    wellbeing resources or ideas for future content, let us
                    know. Your input helps us improve this page and provide more
                    targeted support.
                </Typography>
                <Button variant="contained" color="primary" sx={{ mt: 2 }}>
                    <Link
                        href="https://docs.google.com/forms/d/e/1FAIpQLSdnIioa3gKg1aE0Dk70UH5pTvlBjugAGb6JYsX9OUyD1fnSUA/viewform?usp=sf_link"
                        color="inherit"
                        underline="none"
                        target="_blank"
                    >
...
const mentalHealthArticles = [
    {
        ...
        description:
            "This article provides practical techniques for managing academic pressure, including time management strategies, mindfulness practices, and tips for staying organized during high-stress periods like exams.",
        link: "https://www.unh.edu/pacs/academic-stress-coping-strategies",
    },
    {
        title: "Managing Anxiety in University Life",
        description:
            "University life can be overwhelming, but managing anxiety is possible with proper techniques. Learn how to handle academic, social, and personal stressors with this guide.",
    ...
    },
    {
        ...
        description:
            "Resilience is key to bouncing back from challenges. This guide explores ways to strengthen mental resilience, manage setbacks, and develop a positive outlook.",
...
const physicalWellbeingArticles = [
    {
        ...
        description:
            "Getting enough sleep is essential for concentration, memory, and overall health. Discover how to create a healthy sleep routine that supports your academic goals.",
    ...
    },
    {
        ...
        description:
            "Learn how to maintain a balanced diet with affordable, healthy meal options that keep you energized throughout your busy student life.",
    ...
    },
    {
        ...
        description:
            "Regular physical activity can have a powerful effect on your mental health. Find out how to incorporate quick, effective workouts into your daily routine.",
...
const events = [
    {
        ...
        description:
            "Learn practical meditation techniques to reduce stress and improve focus. Open to all students.",
    ...
    },
    {
        ...
        description:
            "This session will guide students through coping mechanisms for handling exam-related stress and anxiety.",
        registrationLink: "#", // Replace with actual link
    },
    {
        ...
        description:
            "Join us for an hour of beginner-friendly yoga to relieve stress and rejuvenate your mind and body. No prior experience required.",
        registrationLink: "#", // Replace with actual link
    },
];
